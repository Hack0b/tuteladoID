...
public interface ClienteDao {
	...
	/* MO4.1 */ Cliente recuperaPorDni (String dni);
	/* MO4.2 */ Cliente almacena (Cliente client);
	/* MO4.3 */ void elimina (Cliente client);
	/* MO4.4 */ Cliente modifica (Cliente client);

	// OPERACIONS POR ATRIBUTOS LAZY
	/* MO4.5 */ Cliente restauraVentas (Cliente client);
